...
async def roles(ctx):
    ...
    embed.set_author(
        name="nayuta",
        icon_url="https://i.imgur.com/lR3Gshd.png"
    )

    embed.set_footer(
        text=" --- ",
        icon_url="https://i.imgur.com/0NSQW44.png"
    )
...
async def on_message(message):
    if message.channel.id == 1168221032516161626 and message.content.startswith('female '):
